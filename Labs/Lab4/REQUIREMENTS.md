...
The crawler **shall**:
 ...
 3. ignore URLs that are not "internal" (meaning, outside the designated CS50 server).
...
Furthermore, our crawler will limit its crawl to a specific web [server](http://old-www.cs.dartmouth.edu) inside CS, so we don't bother any other servers on campus or beyond.
